    ...
    <div className="bg-gray-900 text-white min-h-screen p-6">
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="flex justify-end p-4">
          <a
            href={`https://www.imdb.com/find/?q=${encodeURIComponent(moviedetail?.title || '')}&ref_=nv_sr_sm`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-2 rounded shadow transition"
          >
            <span>IMDb에서 "{moviedetail?.title}" 검색</span>
          </a>
        </div>
