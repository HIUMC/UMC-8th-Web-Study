...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <div
      ...
      className="relative rounded-xl shadow-lg overflow-hidden cursor-pointer w-44 transition-transfrom duration-500 hover:scale-105"
    ...
    >
      <img
        ...
        alt={movie.title}
        className="rounded-xl shadow-lg object-cover aspect-[2/3] w-[200px]"
      />
