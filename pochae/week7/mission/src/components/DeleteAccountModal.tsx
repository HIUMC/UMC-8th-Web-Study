...
const DeleteAccountModal = ({ onConfirm, onCancle }: DeleteAccountModalProps) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div className="bg-gray-600 text-white p-10 rounded-lg w-90 text-center shadow-xl">
        ...
        <div className="flex justify-center gap-4">
          <button
            onClick={onConfirm}
            className="px-4 py-2 bg-gray-700 text-white rounded hover:scale-90 cursor-pointer"
          >
            예
          </button>
          <button
