...
import { SEARCH_DBOUNCE_DELAY } from "../constants/delay";

const HomePage = () => {
    const[search, setSearch] = useState("");
    const deBouncedValue = useDebounce(search, SEARCH_DBOUNCE_DELAY);
    // 오래된순, 최신순 버튼입니다~~
    ...
    return (
        <div className='container mx-auto px-4 py-6'>
            {/* 검색 박스 */}
            <input 
                className={'border p-3 rounded-sm mt-4 ml-64'}
