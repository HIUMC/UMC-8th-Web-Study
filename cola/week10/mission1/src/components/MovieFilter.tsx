    ...
    <div className="transform space-y-6 rounded-2xl border-gray-300 bg-white p-6 shadow-xl transition-all hover:shadow-2xl">
      <div className="flex flex-wrap gap-6">
        <div className="min-w-[450px] flex-1">
          <label className="mb-2 block text-sm text-gray-700">영화 제목</label>
          <Input value={query} onChange={setQuery} />
        </div>
        <div className="min-w-[450px] flex-1">
          <label className="mb-2 block text-sm text-gray-700">옵션</label>
          <SelectBox
        ...
        <div className="min-w-[250px] flex-1">
          <label className="mb-2 block text-sm text-gray-700">언어</label>
          <LanguageSelector
            value={language}
